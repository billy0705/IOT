...
$(document).ready(function () {
    ...
    // header.html import
    $.ajax({
        url: dht_home + '/template/header.html',
        async: false,
        success: function (data) {
            $('.header').html(data);
            console.log("header load succsee!!");
            $('.link-home').attr('href', dht_home + "/");
            $('.link-display').attr('href', dht_home + "/displayDashboard");
            $('.link-oven').attr('href', dht_home + "/solderOven");
            $('.link-sensor').attr('href', dht_home + "/sensorDashboard");
        }
    });
