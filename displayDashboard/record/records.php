	...
	<div class="header"></div>
		...
		<div class="formandlist">
			...
			<div class="link-bar" style="float:right; margin: auto;">
				...
				<a style = "width : 70px" class="modify" href="./records.php?locationid=<?php echo $locationid;?>&sensorid=<?php echo $sensorid;?>&selectdate=<?php echo $selectdate;?>&timeInterval=5">5min</a>
				<?php } ?>
				<?php if ($timeInterval != 15){ ?>
				<a style = "width : 70px" class="modify" href="./records.php?locationid=<?php echo $locationid;?>&sensorid=<?php echo $sensorid;?>&selectdate=<?php echo $selectdate;?>&timeInterval=15">15min</a>
				<?php } ?>
