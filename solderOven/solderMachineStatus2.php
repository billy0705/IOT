...
<div class="sensordashboard">
		...
		<a style="display:block; width:100px" <?php if ($row[8] == 'A') echo ' class="active"';
												else echo ' class = "down"' ?>><?php if ($row[8] == 'A') echo 'Active';
																					else echo 'Stop' ?></a>
		<a style="display:block; width:10px"></a>
		<a style="display:block; width:200px" <?php if ($tStatus == 0) echo ' class="active"';
												else echo ' class = "down"' ?>><?php echo $t ?></a>
		<a style="display:block; width:10px"></a>
		<a style="display:block; width:180px" <?php if ($hStatus == 0) echo ' class="active"';
												else echo ' class = "down"' ?>><?php echo $h ?></a>
